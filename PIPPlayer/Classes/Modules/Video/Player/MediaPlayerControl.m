...
- (void)initSubviews; {
    ...
    [_topView.contentView addSubview:_backButton];
    
    _titleLabel = [[UILabel alloc] init];
    _titleLabel.textColor = [UIColor whiteColor];
    _titleLabel.font = [UIFont systemFontOfSize:14];
    [_topView.contentView addSubview:_titleLabel];
    ...
    [_bottomView.contentView addSubview:_progressView];
    ...
    [_bottomView.contentView addSubview:_currentTimeLabel];
    ...
    [_bottomView.contentView addSubview:_durationLabel];
